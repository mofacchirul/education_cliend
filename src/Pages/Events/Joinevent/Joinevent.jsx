...
const Joinevent = () => {
    ...
    return (
        <div>
             <div className='text-center flex-col items-center justify-center w-1/2 mx-auto py-10'>
                <h1 className="text-yellow-500 mx-auto  text-center lg:text-3xl font-bold border-b-2 border-yellow-500 flex items-center gap-2 w-36 lg:w-48">
        ...
        <div className="max-w-3xl mx-auto p-6     shadow-lg rounded-lg mt-10">
            ...
            <p className="text-gray-100 mt-2">{data.event_description}</p>
            
            <div className="mt-4">
                <h2 className="text-2xl font-semibold">Event Details</h2>
                <p className="text-gray-100 mt-2">{data.event_details}</p>
            </div>
            
            <div className="mt-4">
                <h2 className="text-2xl font-semibold">Why Join?</h2>
                <p className="text-gray-100 mt-2">{data.power_of_choice}</p>
            </div>
            
            <div className="mt-4">
                <h2 className="text-2xl font-semibold">Requirements</h2>
                <ul className="list-disc list-inside text-yellow-500 mt-2">
            ...
            <div className="mt-4">
                ...
                <p className="text-gray-100 mt-2">{data.professional_experience}</p>
            </div>
