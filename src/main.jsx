...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://education-server-gilt.vercel.app/courses/${params.id}`
          ),
      },
      {
        path: "join_event/:id",
        ...
        loader: ({ params }) =>
          fetch(`https://education-server-gilt.vercel.app/events/${params.id}`),
      },
      {
        path: "blog_detels/:id",
        element: (
        ...
        loader: ({ params }) =>
          fetch(`https://education-server-gilt.vercel.app/blog/${params.id}`),
      },
      {
        path: "course",
