...
const Admin_home = () => {
  ...
  const [admin_status]= UseAdmin()

  
    return (
        <div className=" flex-col items-cente bg-white shadow-2xl rounded-3xl p-10  ">
            <div className=" w-full mx-auto max-w-5xl text-center">
                <h1 className="lg:text-4xl text-xl font-extrabold text-gray-900 flex gap-0.5 items-center text-center justify-center mb-6">Welcome, 
                    <span>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-3'>
             <div className='px-7 font-bold flex items-center gap-1 text-xl lg:text-4xl py-10 text-white bg-yellow-500 rounded-4xl text-center'>
             ...
             <div className='px-7 font-bold flex items-center gap-1 text-xl lg:text-4xl py-10 text-white bg-teal-900 rounded-4xl text-center'>
